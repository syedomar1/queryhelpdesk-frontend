            ...
            <table className="container table table-hover mt-2">
                <thead>
                    <tr>
                        ...
                        <th scope="col" className='text-center'>Issues</th>
                        ...
                        <React.Fragment key={index}>
                            <tr onClick={() => handleRowClick(index)} style={{ cursor: 'pointer' }}>
                                ...
                                <td>
                                    ...
                                    >
                                        <option value="notViewed" className="bg-danger text-light">Not Viewed</option>
                                        <option value="onProgress" className="bg-warning text-dark">On Progress</option>
                                        <option value="resolved" className="bg-success text-light">Resolved</option>
                                    </select>
                                </td>
                            </tr>
                            {expandedRow === index && (
                                <tr>
                                    <td>Solution: </td>
                                    <td colSpan="2">
                                        <textarea className="form-control" rows="3" placeholder="Resolve this issue"></textarea>
                                    </td>
